 ...
 *   classic  → auto-generated by ClassicStrategy (generic STRIDE per element type)
 *   hybrid   → auto-generated by HybridStrategy (STRIDE modulated by element properties)
 *   relation → auto-generated by RelationStrategy (STRIDE derived from asset CIANAAA goals)
 */
export type ThreatSource = "manual" | "classic" | "hybrid" | "relation";
