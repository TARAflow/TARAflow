...
/**
 * Ratio of DFD elements with at least one linked asset.
 * 0.0 = no elements have assets
 * 1.0 = all elements have assets
 *
 * Exported for use by StrategyIndicator component in the Threat Tab.
 */
export function computeAssetCoverage(project: ThreatProjectData): number {
