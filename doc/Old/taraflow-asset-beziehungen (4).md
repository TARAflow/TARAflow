...
IF serviceType === "managed" AND responsibilityScope === ""
THEN Validierungsfehler (blockierend):
     "Managed Services sind vollständige Blackboxes.
      responsibilityScope MUSS die Schnittstellen-Absicherung beschreiben:
      - Welche API-Endpunkte sind in eigener Verantwortung?
...
> **Warum blockierend bei `managed`?** Ein vollständig externer Managed Service ohne
> dokumentierten `responsibilityScope` ist ein analytisches Loch im Risikobericht.
> Der Auditor sieht eine Abhängigkeit aber keine Verantwortungszuweisung — das ist
> ein direkter CRA-Konformitätsmangel.
